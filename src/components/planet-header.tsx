    ...
    <div className="mb-2 flex items-start justify-between gap-2">
      <div className="flex shrink-0 items-center gap-2">
        <Link
          href="/profile"
          aria-label="Profile"
          className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-cyan-400/50 bg-gradient-to-tr from-cyan-600 to-indigo-900 shadow-[0_0_15px_rgba(0,240,255,0.35)]"
        >
