...
export const DEBUG_INFO = {
  ...
  missing: [
    ...
    "Colony ship, missiles (fire/silo war), crawlers, space dock repair, phalanx, jump gate, terraformer fields, and IRN lab-sharing are catalogued but not functional.",
